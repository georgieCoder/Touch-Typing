...
interface typingState {
    ...
    passedText: string,
    comingText: string,
    countCorrectKeys: number,
    countWrongKeys: number,
    started: boolean,
    wasOnceStarted: boolean,
    wasCorrect: boolean,
    wasWrong: boolean,
    time: number,
    timeLimit: number,
...
const typingSlice = createSlice({
     ...
     initialState,
     reducers: {
        initTypingField(state, action: PayloadAction<{text: string, lengthLimit: number}>) {
        ...
        updateTypingTime(state, action: PayloadAction<number>) {
